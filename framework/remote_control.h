    ...
    <div class="page-view">
        ...
        <div class="item-view">
            ...
            <div class="rocker-mode">
                <div class="item">
                    <div id="rocker-left" class="item-select select" onclick="onSelectRocker('left')">左摇杆</div>
                </div>
                <div class="item">
                    <div id="rocker-right" class="item-select" onclick="onSelectRocker('right')">右摇杆</div>
                </div>
            </div>
